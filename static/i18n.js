...
const LOCALES = {
  en: {
    ...
    mcp_restart_hint: 'Server changes are read-only here for now. Edit config.yaml and restart 云千易 for changes to take effect.',
    ...
    untitled: 'Untitled',
    /** Shown in sidebar/top bar for ephemeral chats; server title may remain "Untitled". */
    new_conversation_placeholder: 'New conversation',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" may not work with your configured provider (${p}). Send anyway, or run \`云千易 model\` in your terminal to switch.`,
    ...
    cmd_skills: 'List available 云千易 skills',
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    settings_section_preferences_meta: 'Defaults and UI behavior for 云千易.',
    ...
    kanban_assignee_filter: 'Assignee filter',
    kanban_tenant_filter: 'Tenant filter',
    kanban_bulk_status_aria: 'Bulk status',
    kanban_bulk_status_prompt: 'Status',
    kanban_board_name_placeholder: 'e.g. Experiments',
    kanban_board_slug_placeholder: 'experiments',
    kanban_board_default: 'Default',
    tab_todos: 'Todos',
    tab_insights: 'Insights',
    tab_dashboard: '云千易 Dashboard',
    ...
    settings_desc_voice_mode: 'Show the voice-mode button (audio waveform) next to the dictation mic. Lets you speak naturally — 云千易 auto-sends after a pause and reads replies aloud. Requires a browser that supports both speech recognition and TTS.',
    settings_label_tts_voice: 'Voice',
    settings_desc_tts_voice: "Preferred voice. Populated from your browser's available voices.",
    settings_tts_voice_default: 'Default system voice',
    ...
    settings_desc_sync_insights: 'Mirrors WebUI token usage to state.db so 云千易 /insights includes browser session data. Off by default.',
    ...
    settings_desc_bot_name: 'Display name for the assistant throughout the UI. Defaults to 云千易 .',
    ...
    settings_dropdown_plugins: 'Plugins',
    settings_section_plugins_title: 'Plugins',
    settings_section_plugins_meta: 'View installed 云千易 plugins and the lifecycle hooks they register. This panel is read-only.',
    plugins_panel_empty: 'No 云千易 plugins are currently visible. Install or enable plugins from the 云千易 CLI/config to see them here.',
    ...
    settings_label_show_tps: 'Show token speed (TPS)',
    settings_desc_show_tps: 'Displays tokens per second in assistant message headers while streaming and after a response completes. Off by default.',
    settings_label_simplified_tool_calling: 'Compact tool activity',
    settings_desc_simplified_tool_calling: 'Group thinking and tool calls into one collapsed activity section per assistant turn.',
    settings_export_json_title: 'Export full session as JSON',
    settings_import_json_title: 'Import session from JSON',
    settings_clear_conv_title: 'Clear all messages in this conversation',
    settings_action_export_json: 'JSON',
    settings_action_clear: 'Clear',
    settings_label_official_dashboard: 'Official 云千易 Dashboard',
    settings_desc_official_dashboard: 'Show a nav-rail link when the official 云千易 dashboard is reachable. Overrides are restricted to loopback URLs.',
    settings_dashboard_auto: 'Auto-detect',
    settings_dashboard_always: 'Always show',
    settings_dashboard_never: 'Never show',
    settings_save_dashboard_link: 'Save dashboard link settings',
    settings_gateway_status_label: 'Gateway Status',
    settings_gateway_status_desc: 'Status of the 云千易 gateway (Telegram, Discord, Slack, etc.)',
    settings_gateway_loading: 'Loading…',
    settings_gateway_not_running: 'Gateway not running',
    settings_gateway_running: 'Running',
    settings_gateway_last_active: 'Last active:',
    settings_gateway_sessions_one: '1 session',
    settings_gateway_sessions_many: '{count} sessions',
    settings_gateway_load_failed: 'Failed to load gateway status',
    settings_badge_webui: 'WebUI:',
    settings_badge_agent: 'Agent:',
    settings_version_unknown: 'not detected',
    ...
    provider_quota_remaining: 'Remaining',
    provider_quota_used: 'Used',
    provider_quota_limit: 'Limit',
    providers_panel_load_failed: 'Failed to load providers:',
    providers_quota_unavailable: 'Quota status unavailable',
    password_placeholder: 'Enter new password…',
    password_env_var_locked: 'The 云千易 _WEBUI_PASSWORD environment variable is currently set and takes precedence. Unset it and restart the server to manage the password from here.',
    password_env_var_locked_placeholder: 'Locked: 云千易 _WEBUI_PASSWORD env var is set',
    ...
    providers_oauth_config_yaml_hint: 'Token configured via config.yaml. To update, edit the providers section in your config.yaml or run 云千易 auth.',
    providers_oauth_not_configured_hint: 'Not authenticated. Run 云千易 auth in the terminal to configure this provider.',
    providers_save: 'Save',
    ...
    empty_title_named: 'Hi, {0}, what can I help with?',
    ...
    onboarding_title: 'Welcome to 云千易',
    onboarding_lead: 'A quick guided setup will verify 云千易 , save a real provider configuration, choose a workspace and model, and optionally protect the app with a password.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip setup',
    onboarding_skipped: 'Setup skipped — using existing config.',
    onboarding_open: 'Open 云千易 ',
    onboarding_step_system_title: 'System check',
    onboarding_step_system_desc: 'Verify 云千易 Agent and config visibility.',
    onboarding_step_setup_title: 'Provider setup',
    onboarding_step_setup_desc: 'Save the minimum 云千易 provider config.',
    ...
    onboarding_notice_system_ready: '云千易 Agent looks reachable from the Web UI.',
    onboarding_notice_system_unavailable: '云千易 Agent is not fully available yet. Bootstrap can install it, but provider setup may still require a terminal.',
    onboarding_check_agent: '云千易 Agent',
    ...
    onboarding_notice_setup_required: 'Choose a simple provider path here. Advanced OAuth flows still belong in the 云千易 CLI for now.',
    onboarding_notice_setup_already_ready: 'A working 云千易 provider setup is already detected. You can keep it or replace it here.',
    onboarding_oauth_provider_ready_title: 'Provider already authenticated',
    onboarding_oauth_provider_ready_body: 'This instance is configured to use an OAuth provider (<strong>{provider}</strong>) that was set up via the 云千易 CLI. No API key is needed here — click Continue to finish setup.',
    onboarding_oauth_provider_not_ready_title: 'OAuth provider not yet authenticated',
    onboarding_oauth_provider_not_ready_body: 'This instance is configured to use <strong>{provider}</strong>, which uses OAuth rather than an API key. Run <code>云千易 auth</code> or <code>云千易 model</code> in a terminal to authenticate, then reload the Web UI.',
    ...
    onboarding_api_key_help_prefix: 'Saved as a secret in your 云千易 .env file using',
    ...
    onboarding_workspace_help: 'Pick the model 云千易 should use for new chats after setup completes.',
    ...
    skills_sidebar_empty: 'No skills to display.',
    skills_section_bundled: 'Bundled skills (Hermes)',
    skills_section_personal: 'Personal skills',
    ...
    reasoning_effort_chip_title: 'Reasoning effort: {0}',
    reasoning_toast_set: 'Reasoning effort set to {0}',
    reasoning_toast_failed: 'Failed to set reasoning effort',
    composer_mobile_config_title: 'Workspace, model, reasoning, and context',
    composer_workspace_group_aria: 'Workspace controls',
    ctx_tooltip_title: 'Context window',
    ctx_indicator_aria: 'Context window usage',
    bg_badge_title: 'Background tasks running',
    drop_files_hint: 'Drop files here to upload to workspace',
    composer_attach: 'Attach files',
    queue_region_aria: 'Queued messages',
    queue_pill_aria: 'Show queued messages',
    insights_period_7: 'Last 7 days',
    insights_period_30: 'Last 30 days',
    insights_period_90: 'Last 90 days',
    insights_period_365: 'Last 365 days',
    gateway_status_label: 'Gateway status',
    gateway_status_desc: 'Status of the 云千易 gateway (Telegram, Discord, Slack, etc.)',
    gateway_loading: 'Loading…',
    agent_health_details: 'The gateway heartbeat failed. Messages may not be delivered until it comes back.',
    agent_health_state: 'State: {0}.',
    agent_health_alert_message: 'Gateway heartbeat failed.{0} Messages may not be delivered until it comes back.',
    ...
    workspace_file_unread_tooltip: 'New or updated this session — not opened or downloaded yet',
    workspace_panel_title: 'Workspace',
    workspace_panel_hide: 'Hide workspace panel',
    workspace_parent_dir: 'Parent directory',
    workspace_new_file: 'New file',
    workspace_new_folder: 'New folder',
    workspace_refresh: 'Refresh',
    workspace_close_preview: 'Close preview',
    workspace_close_panel: 'Close workspace panel',
    workspace_terminal_aria: 'Workspace terminal',
    file_download: 'Download',
    file_edit: 'Edit',
    preview_pdf_title: 'PDF preview',
    preview_html_title: 'HTML preview',
    open_in_new_tab: 'Open in new browser tab',
    cron_refresh_list_title: 'Refresh job list',
    insights_refresh_title: 'Refresh',
    model_select_title: 'Conversation model',
    menu_hamburger: 'Menu',
    primary_nav_aria: 'Primary navigation',
    scroll_to_bottom_aria: 'Scroll to bottom',
  ...
  ja: {
    ...
    untitled: '無題',
    new_conversation_placeholder: '新しい会話',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" は設定されたプロバイダ (${p}) で動作しない可能性があります。このまま送信するか、ターミナルで \`云千易 model\` を実行して切り替えてください。`,
  ...
  folder_add_as_space_title: 'スペースとして追加?',
    ...
    settings_section_preferences_meta: '云千易 のデフォルトと UI 動作。',
    ...
    settings_desc_sync_insights: 'WebUI のトークン使用量を state.db にミラーし、云千易 /insights にブラウザセッションのデータを含めます。デフォルトはオフ。',
    settings_desc_check_updates: 'WebUI または Agent の新しいバージョンが利用可能な時にバナーを表示します。バックグラウンドで定期的に git fetch を実行します。',
    settings_desc_bot_name: 'UI 全体で表示されるアシスタントの名前。デフォルトは 云千易 。',
    settings_desc_password: '新しいパスワードを入力すると設定または変更します。空欄なら現在の設定を維持。',
    password_placeholder: '新しいパスワードを入力…',
    password_env_var_locked: '現在 云千易 _WEBUI_PASSWORD 環境変数が設定されており優先されます。ここで管理するには変数を解除してサーバーを再起動してください。',
    password_env_var_locked_placeholder: 'ロック中: 云千易 _WEBUI_PASSWORD 環境変数が設定されています',
    disable_auth: '認証を無効化',
    sign_out: 'サインアウト',
    // Providers panel
    ...
    providers_oauth_config_yaml_hint: 'config.yaml でトークンが設定されています。更新するには config.yaml の providers セクションを編集するか 云千易 auth を実行してください。',
    providers_oauth_not_configured_hint: '未認証です。ターミナルで 云千易 auth を実行してこのプロバイダを設定してください。',
    providers_save: '保存',
    providers_remove: '削除',
    ...
    empty_title_named: 'こんにちは、{0}さん。何をお手伝いしましょう？',
    ...
    onboarding_lead: 'クイックガイドで 云千易 を確認し、プロバイダ設定を保存し、ワークスペースとモデルを選択し、必要ならパスワードでアプリを保護します。',
    onboarding_back: '戻る',
    onboarding_continue: '続ける',
    onboarding_skip: 'セットアップをスキップ',
    onboarding_skipped: 'セットアップをスキップ — 既存設定を使用します。',
    onboarding_open: '云千易 を開く',
    onboarding_step_system_title: 'システム確認',
    onboarding_step_system_desc: '云千易 Agent と設定の可視性を確認します。',
    onboarding_step_setup_title: 'プロバイダ設定',
    onboarding_step_setup_desc: '最低限の 云千易 プロバイダ設定を保存します。',
    ...
    onboarding_notice_system_ready: 'Web UI から 云千易 Agent へ到達できそうです。',
    onboarding_notice_system_unavailable: '云千易 Agent はまだ完全には利用できません。Bootstrap でインストールできますが、プロバイダ設定にはターミナルが必要な場合があります。',
    onboarding_check_agent: '云千易 Agent',
    ...
    onboarding_notice_setup_required: 'シンプルなプロバイダ経路をここで選んでください。高度な OAuth フローは現状 云千易 CLI 側で扱います。',
    onboarding_notice_setup_already_ready: '動作する 云千易 プロバイダ設定が既に検出されています。維持するか、ここで置き換えできます。',
    onboarding_oauth_provider_ready_title: 'プロバイダは認証済み',
    onboarding_oauth_provider_ready_body: 'このインスタンスは 云千易 CLI で設定された OAuth プロバイダ (<strong>{provider}</strong>) を使用します。APIキーは不要 — 続けるをクリックしてセットアップを完了してください。',
    onboarding_oauth_provider_not_ready_title: 'OAuth プロバイダは未認証',
    onboarding_oauth_provider_not_ready_body: 'このインスタンスは <strong>{provider}</strong> を使用しますが、これは APIキー ではなく OAuth を使用します。ターミナルで <code>云千易 auth</code> または <code>云千易 model</code> を実行して認証し、Web UI を再読み込みしてください。',
    ...
    onboarding_api_key_help_prefix: '云千易 の .env ファイルにシークレットとして保存されます — 使用変数:',
    ...
    onboarding_workspace_help: 'セットアップ完了後の新規チャットで 云千易 が使用するモデルを選択してください。',
    onboarding_custom_model_placeholder: 'your-model-name',
  ...
  ru: {
    ...
    new_conversation_placeholder: 'Новый разговор',
    ...
    `"${m}" может не работать с вашим настроенным провайдером (${p}). Всё равно отправить или запустите \`云千易 model\` в терминале, чтобы переключиться.`,
    ...
    cmd_skills: 'Показать доступные навыки 云千易 ',
  ...
  folder_add_as_space_title: 'Добавить как пространство?',
    ...
    settings_desc_sync_insights: 'Синхронизирует использование токенов WebUI в state.db, чтобы 云千易 /insights включал данные браузерных сеансов. Выключено по умолчанию.',
    ...
    settings_desc_bot_name: 'Отображаемое имя помощника во всём интерфейсе. По умолчанию 云千易 .',
    ...
    password_env_var_locked: 'Переменная окружения 云千易 _WEBUI_PASSWORD сейчас задана и имеет приоритет. Сбросьте её и перезапустите сервер, чтобы управлять паролем отсюда.',
    password_env_var_locked_placeholder: 'Заблокировано: задана переменная 云千易 _WEBUI_PASSWORD',
    ...
    empty_title_named: 'Здравствуйте, {0}! Чем я могу помочь?',
    ...
    onboarding_lead: 'Краткая пошаговая настройка проверит 云千易 , сохранит рабочую конфигурацию провайдера, выберет рабочее пространство и модель и при желании защитит приложение паролем.',
    ...
    onboarding_open: 'Открыть 云千易 ',
    onboarding_step_system_title: 'Проверка системы',
    onboarding_step_system_desc: 'Проверить 云千易 Agent и видимость конфигурации.',
    onboarding_step_setup_title: 'Настройка провайдера',
    onboarding_step_setup_desc: 'Сохранить минимальную рабочую конфигурацию провайдера 云千易 .',
    ...
    onboarding_notice_system_ready: '云千易 Agent, похоже, доступен из Web UI.',
    onboarding_notice_system_unavailable: '云千易 Agent ещё не полностью доступен. Bootstrap может установить его, но для настройки провайдера всё ещё может понадобиться терминал.',
    onboarding_check_agent: '云千易 Agent',
    ...
    onboarding_notice_setup_required: 'Выберите здесь простой путь настройки провайдера. Продвинутые OAuth-сценарии пока остаются в 云千易 CLI.',
    onboarding_notice_setup_already_ready: 'Уже обнаружена рабочая конфигурация провайдера 云千易 . Вы можете оставить её или заменить здесь.',
    onboarding_oauth_provider_ready_title: 'Провайдер уже авторизован',
    onboarding_oauth_provider_ready_body: 'Этот экземпляр настроен на использование OAuth-провайдера (<strong>{provider}</strong>), настроенного через 云千易 CLI. API-ключ здесь не нужен — нажмите «Продолжить», чтобы завершить настройку.',
    onboarding_oauth_provider_not_ready_title: 'OAuth-провайдер ещё не авторизован',
    onboarding_oauth_provider_not_ready_body: 'Этот экземпляр настроен на использование <strong>{provider}</strong>, который работает через OAuth, а не через API-ключ. Запустите <code>云千易 auth</code> или <code>云千易 model</code> в терминале, чтобы пройти авторизацию, затем обновите Web UI.',
    ...
    onboarding_api_key_help_prefix: 'Сохраняется как секрет в вашем файле `.env` 云千易 с помощью',
    ...
    onboarding_workspace_help: 'Выберите модель, которую 云千易 должен использовать для новых чатов после завершения настройки.',
    ...
    settings_desc_voice_mode: 'Показывать кнопку голосового режима (аудиоволны) рядом с микрофоном диктовки. 云千易 автоматически отправляет реплики после паузы и зачитывает ответы вслух. Требуется браузер с поддержкой распознавания речи и TTS.',
  ...
  es: {
    ...
    untitled: 'Sin título',
    new_conversation_placeholder: 'Nueva conversación',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" puede no funcionar con tu proveedor configurado (${p}). Envía de todas formas, o ejecuta \`云千易 model\` en la terminal para cambiar.`,
    ...
    cmd_skills: 'Listar las skills de 云千易 disponibles',
  ...
  folder_add_as_space_title: '¿Añadir como espacio?',
    ...
    settings_desc_sync_insights: 'Refleja el uso de tokens de la WebUI en state.db para que 云千易 /insights incluya datos de sesiones del navegador. Desactivado por defecto.',
    ...
    settings_desc_bot_name: 'Nombre visible del asistente en toda la UI. Por defecto es 云千易 .',
    ...
    password_env_var_locked: 'La variable de entorno 云千易 _WEBUI_PASSWORD está definida y tiene prioridad. Quítala y reinicia el servidor para gestionar la contraseña desde aquí.',
    password_env_var_locked_placeholder: 'Bloqueado: la variable 云千易 _WEBUI_PASSWORD está definida',
    ...
    empty_title_named: 'Hola, {0}, ¿en qué puedo ayudarte?',
    ...
    onboarding_title: 'Bienvenido a 云千易',
    onboarding_lead: 'Una guía rápida verificará 云千易 , guardará una configuración real del proveedor, elegirá un espacio de trabajo y un modelo, y opcionalmente protegerá la app con una contraseña.',
    ...
    onboarding_open: 'Abrir 云千易 ',
    onboarding_step_system_title: 'Comprobación del sistema',
    onboarding_step_system_desc: 'Verifica 云千易 Agent y la visibilidad de la configuración.',
    onboarding_step_setup_title: 'Configuración del proveedor',
    onboarding_step_setup_desc: 'Guarda la configuración mínima real de 云千易 .',
    ...
    onboarding_notice_system_ready: 'Parece que 云千易 Agent está accesible desde la Web UI.',
    onboarding_notice_system_unavailable: '云千易 Agent todavía no está totalmente disponible. Bootstrap puede instalarlo, pero la configuración del proveedor quizá aún requiera una terminal.',
    onboarding_check_agent: '云千易 Agent',
    ...
    onboarding_notice_setup_required: 'Elige aquí una ruta simple de proveedor. Los flujos OAuth avanzados siguen siendo del CLI de 云千易 por ahora.',
    onboarding_notice_setup_already_ready: 'Ya se detectó una configuración funcional del proveedor de 云千易 . Puedes conservarla o reemplazarla aquí.',
    onboarding_oauth_provider_ready_title: 'Proveedor ya autenticado',
    onboarding_oauth_provider_ready_body: 'Esta instancia está configurada para usar un proveedor OAuth (<strong>{provider}</strong>) configurado mediante la CLI de 云千易 . No se necesita clave API aquí — haz clic en Continuar para finalizar la configuración.',
    onboarding_oauth_provider_not_ready_title: 'Proveedor OAuth no autenticado aún',
    onboarding_oauth_provider_not_ready_body: 'Esta instancia está configurada para usar <strong>{provider}</strong>, que utiliza OAuth en lugar de una clave API. Ejecuta <code>云千易 auth</code> o <code>云千易 model</code> en una terminal para autenticarte y recarga la interfaz web.',
    ...
    oauth_codex_error: 'OAuth login failed', // TODO: translate
    oauth_codex_expired: 'Code expired, please try again', // TODO: translate
    onboarding_api_key_help_prefix: 'Se guarda como secreto en tu archivo .env de 云千易 usando',
    onboarding_base_url_label: 'Base URL',
    ...
    onboarding_workspace_help: 'Elige el modelo que 云千易 debe usar para nuevos chats cuando termine la configuración.',
    ...
    composer_placeholder: 'Chatea con {0}…',
    ...
    settings_desc_voice_mode: 'Show the voice-mode button (audio waveform) next to the dictation mic. Lets you speak naturally — 云千易 auto-sends after a pause and reads replies aloud. Requires a browser that supports both speech recognition and TTS.',  // TODO: translate
  ...
  de: {
    ...
    untitled: 'Unbenannt',
    new_conversation_placeholder: 'Neue Unterhaltung',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" funktioniert möglicherweise nicht mit Ihrem konfigurierten Provider (${p}). Trotzdem senden, oder \`云千易 model\` im Terminal ausführen.`,
    ...
    cmd_skills: 'Verfügbare 云千易 -Skills auflisten',
  ...
  folder_add_as_space_title: 'Als Bereich hinzufügen?',
    ...
    settings_desc_sync_insights: 'Spiegelt den WebUI-Token-Verbrauch in die state.db, sodass 云千易 /insights Browser-Sitzungsdaten enthält. Standardmäßig aus.',
    ...
    settings_desc_bot_name: 'Anzeigename für den Assistenten in der UI. Standardmäßig 云千易 .',
    ...
    password_env_var_locked: 'Die Umgebungsvariable 云千易 _WEBUI_PASSWORD ist gesetzt und hat Vorrang. Entferne sie und starte den Server neu, um das Passwort hier zu verwalten.',
    password_env_var_locked_placeholder: 'Gesperrt: 云千易 _WEBUI_PASSWORD-Umgebungsvariable ist gesetzt',
    ...
    empty_title_named: 'Hallo, {0}, wie kann ich helfen?',
    ...
    composer_placeholder: 'Mit {0} chatten…',
    ...
    onboarding_title: 'Willkommen bei 云千易 ',
    ...
    onboarding_step_system_desc: '云千易 Agent muss installiert und erreichbar sein.',
    ...
    onboarding_notice_system_unavailable: 'Agent nicht erreichbar. Bitte starten Sie 云千易 Agent.',
  ...
  zh: {
    ...
    mcp_restart_hint: '此处暂时只读。请编辑 config.yaml 并重启 云千易 后生效。',
    mcp_toggle_followup: '启用/禁用控件将在 MCP 热重载语义明确后再提供。',
    mcp_status_active: '活动中',
    ...
    mcp_tools_desc: '在当前已连接的 MCP 服务器中搜索已知工具。',
    mcp_tools_search_placeholder: '按名称、服务器或描述搜索工具…',
    mcp_tools_no_tools: '当前运行环境中没有可用的 MCP 工具。',
    mcp_tools_no_matches: '没有匹配搜索条件的 MCP 工具。',
    mcp_tools_load_failed: 'MCP 工具加载失败。',
    mcp_tools_schema_empty: '无 schema 参数。',
    mcp_tools_runtime_note: '工具列表仅使用已知运行时数据；WebUI 不会启动或探测 MCP 服务器。',
    thinking: '\u601d\u8003\u8fc7\u7a0b',
    expand_all: '\u5168\u90e8\u5c55\u5f00',
    collapse_all: '\u5168\u90e8\u6298\u53e0',
    edit_failed: '\u7f16\u8f91\u5931\u8d25\uff1a',
    ...
    untitled: '\u672a\u547d\u540d',
    new_conversation_placeholder: '\u65b0\u5bf9\u8bdd',
    n_messages: (n) => `${n} \u6761\u6d88\u606f`,
    ...
    provider_mismatch_warning: (m,p)=>`\"${m}\" \u53ef\u80fd\u65e0\u6cd5\u5728\u5f53\u524d\u914d\u7f6e\u7684\u63d0\u4f9b\u5546 (${p}) \u4e0b\u5de5\u4f5c\u3002\u76f4\u63a5\u53d1\u9001\uff0c\u6216\u5728\u7ec8\u7aef\u8fd0\u884c \`云千易 model\` \u5207\u6362\u3002`,
    ...
    settings_busy_input_mode_steer: 'Steer（中途纠正，不打断当前轮）',
  ...
  folder_add_as_space_title: '\u6dfb\u52a0\u4e3a\u5de5\u4f5c\u533a\uff1f',
    ...
    cmd_reasoning: '切换思考过程显示（show/hide）、设置力度或查看当前状态',
    ...
    tab_kanban: '\u770b\u677f',
    kanban_board: '\u770b\u677f',
    kanban_visible_tasks: '\u5171 {0} \u4e2a\u53ef\u89c1\u4efb\u52a1',
    ...
    kanban_nudge_dispatcher: '\u89e6\u53d1\u8c03\u5ea6',
    kanban_stats: '\u7edf\u8ba1',
    kanban_worker_log: 'Worker \u65e5\u5fd7',
    kanban_block: '\u963b\u585e',
    kanban_unblock: '\u89e3\u9664\u963b\u585e',
    kanban_back_to_board: '\u8fd4\u56de\u770b\u677f',
    kanban_lanes_by_profile: '\u6309\u914d\u7f6e\u5206\u5217',
    kanban_new_board: '\u65b0\u5efa\u770b\u677f\u2026',
    kanban_rename_board: '\u91cd\u547d\u540d\u5f53\u524d\u770b\u677f\u2026',
    kanban_archive_board: '\u5f52\u6863\u5f53\u524d\u770b\u677f\u2026',
    kanban_archive_board_confirm: '\u786e\u5b9a\u5f52\u6863\u770b\u677f\u300c{name}\u300d\uff1f\u4efb\u52a1\u4ecd\u4fdd\u7559\u5728\u78c1\u76d8\uff0c\u53ef\u4ece kanban/boards/_archived/ \u6062\u590d\u3002',
    kanban_board_archived: '\u770b\u677f\u5df2\u5f52\u6863',
    kanban_board_name: '\u540d\u79f0',
    kanban_board_slug: '\u6807\u8bc6\uff08\u5c0f\u5199\u3001\u8fde\u5b57\u7b26\uff09',
    kanban_board_description: '\u63cf\u8ff0\uff08\u9009\u586b\uff09',
    kanban_board_icon: '\u56fe\u6807\uff08\u8868\u60c5\uff0c\u9009\u586b\uff09',
    kanban_board_color: '\u989c\u8272\uff08\u9009\u586b\uff09',
    kanban_board_name_required: '\u8bf7\u8f93\u5165\u540d\u79f0',
    kanban_board_slug_required: '\u8bf7\u8f93\u5165\u6807\u8bc6',
    kanban_card_start: '\u5f00\u59cb',
    kanban_card_complete: '\u5b8c\u6210',
    kanban_card_archive: '\u5f52\u6863',
    kanban_unassigned: '\u672a\u5206\u914d',
    kanban_status_archived: '\u5df2\u5f52\u6863',
    kanban_assignee_filter: '\u8d1f\u8d23\u4eba\u7b5b\u9009',
    kanban_tenant_filter: '\u79df\u6237\u7b5b\u9009',
    kanban_bulk_status_aria: '\u6279\u91cf\u72b6\u6001',
    kanban_bulk_status_prompt: '\u72b6\u6001',
    kanban_board_name_placeholder: '\u4f8b\u5982\uff1a\u5b9e\u9a8c',
    kanban_board_slug_placeholder: 'experiments',
    kanban_board_default: '\u9ed8\u8ba4',
    tab_todos: '待办',
    tab_insights: '统计',
    tab_dashboard: '云千易 仪表盘',
    ...
    logs_status_idle: '请选择一个日志文件以查看最近行。',
    logs_no_mtime: '尚未写入',
    logs_truncated_hint: '以下为超大日志文件的末尾片段；为控制内存已跳过更早的字节。',
    logs_copied: '日志已复制',
    ...
    editing: '编辑中',
    empty_title: '有什么可以帮您？',
    empty_title_named: '你好，{0}，有什么可以帮您？',
    ...
    providers_section_meta: '管理各 AI 提供商的 API 密钥，保存后立即生效。',
    ...
    providers_oauth_hint: '已通过 OAuth 登录，无需 API 密钥。',
    providers_oauth_config_yaml_hint: '令牌已在 config.yaml 中配置。若要更新，请编辑配置文件中的 providers 段或在终端运行 云千易 auth。',
    providers_oauth_not_configured_hint: '尚未完成认证。请在终端运行 云千易 auth 以配置此提供商。',
    providers_save: '保存',
    providers_remove: '移除',
    providers_saving: '保存中…',
    providers_removing: '移除中…',
    providers_enter_key: '请输入 API 密钥',
    providers_empty: '未找到可在此配置的提供商。',
    providers_key_updated: 'API 密钥已保存',
    providers_key_removed: 'API 密钥已移除',
    providers_key_placeholder_new: 'sk-...',
    providers_key_placeholder_replace: '输入新密钥以替换…',
    providers_panel_load_failed: '加载提供商列表失败：',
    providers_quota_unavailable: '无法获取配额状态',
    provider_quota_title: '当前提供商配额',
    provider_quota_remaining: '剩余',
    provider_quota_used: '已用',
    provider_quota_limit: '限额',
    password_placeholder: '输入新密码…',
    password_env_var_locked: '当前已设置 云千易 _WEBUI_PASSWORD 环境变量并具有优先级。请取消该变量并重启服务器，才能在此管理密码。',
    ...
    settings_desc_sync_insights: '将 WebUI token 使用情况同步到 state.db，使 云千易 /insights 包含浏览器会话数据。默认关闭。',
    settings_desc_check_updates: '当有更新的 WebUI 或助手版本时显示横幅。会在后台定期执行 git fetch。',
    settings_desc_bot_name: '助手在 UI 中的显示名称。默认为 云千易 。',
    ...
    onboarding_lead: '快速引导将验证云千易、保存真实的提供商配置、选择工作区和模型，并可选设置密码保护应用。',
    onboarding_back: '返回',
    onboarding_continue: '继续',
    onboarding_skip: '跳过设置',
    onboarding_skipped: '设置已跳过 — 使用现有配置。',
    onboarding_open: '打开 云千易 ',
    onboarding_step_system_title: '系统检查',
    onboarding_step_system_desc: '验证 云千易 Agent 与配置可见性。',
    onboarding_step_setup_title: '提供商设置',
    onboarding_step_setup_desc: '保存最小可用的 云千易 提供商配置。',
    ...
    onboarding_notice_system_ready: '云千易 Agent 看起来可从 Web UI 访问。',
    onboarding_notice_system_unavailable: '云千易 Agent 尚未完全可用。Bootstrap 可以安装它，但提供商设置可能仍需要终端。',
    onboarding_check_agent: '云千易 Agent',
    ...
    onboarding_notice_setup_required: '请先在此选择一个简单的提供商路径。高级 OAuth 流程暂时仍建议在 云千易 CLI 中完成。',
    onboarding_notice_setup_already_ready: '已检测到可用的 云千易 提供商配置。你可以保留它，或在这里替换。',
    onboarding_oauth_provider_ready_title: '提供商已完成认证',
    onboarding_oauth_provider_ready_body: '此实例已配置为使用通过 云千易 CLI 设置的 OAuth 提供商（<strong>{provider}</strong>）。这里不需要 API key，点击继续即可完成设置。',
    onboarding_oauth_provider_not_ready_title: 'OAuth 提供商尚未认证',
    onboarding_oauth_provider_not_ready_body: '此实例已配置为使用 <strong>{provider}</strong>，该提供商使用 OAuth 而非 API key。请在终端运行 <code>云千易 auth</code> 或 <code>云千易 model</code> 完成认证，然后重新加载 Web UI。',
    ...
    skills_sidebar_empty: '暂无可展示的技能。',
    skills_section_bundled: '默认技能（Hermes 内置）',
    skills_section_personal: '个人技能',
    linked_files: '关联文件',
    ...
    settings_section_plugins_title: '插件',
    settings_section_plugins_meta: '查看已安装的 云千易 插件及其注册的生命周期钩子。此面板为只读。',
    plugins_panel_empty: '当前没有可见的 云千易 插件。请在 云千易 CLI 或配置中安装/启用插件后再查看。',
    settings_send_key_enter: 'Enter 发送（Shift+Enter 换行）',
    settings_send_key_ctrl_enter: 'Ctrl+Enter 发送（Enter 换行）',
    settings_theme_light: '浅色',
    settings_theme_dark: '深色',
    settings_theme_system: '跟随系统',
    settings_label_show_tps: '显示 Token 速度（TPS）',
    settings_desc_show_tps: '在流式输出与回复完成后，于助手消息头显示每秒 Token 数。默认关闭。',
    settings_label_simplified_tool_calling: '紧凑展示工具活动',
    settings_desc_simplified_tool_calling: '将思考过程与工具调用合并为每条助手回复下的一个可折叠活动区块。',
    settings_export_json_title: '导出完整会话为 JSON',
    settings_import_json_title: '从 JSON 导入会话',
    settings_clear_conv_title: '清空当前对话中的所有消息',
    settings_action_export_json: 'JSON',
    settings_action_clear: '清空',
    settings_label_official_dashboard: '官方 云千易 仪表盘',
    settings_desc_official_dashboard: '当本机可访问官方 云千易 dashboard 时，在导航栏显示入口。覆盖规则仅限于 loopback URL。',
    settings_dashboard_auto: '自动检测',
    settings_dashboard_always: '始终显示',
    settings_dashboard_never: '永不显示',
    settings_save_dashboard_link: '保存仪表盘链接设置',
    settings_gateway_status_label: '网关状态',
    settings_gateway_status_desc: '云千易 网关状态（Telegram、Discord、Slack 等）。',
    settings_gateway_loading: '加载中…',
    settings_gateway_not_running: '网关未运行',
    settings_gateway_running: '运行中',
    settings_gateway_last_active: '最近活动：',
    settings_gateway_sessions_one: '1 个会话',
    settings_gateway_sessions_many: '{count} 个会话',
    settings_gateway_load_failed: '网关状态加载失败',
    settings_badge_webui: 'WebUI:',
    settings_badge_agent: 'Agent:',
    settings_version_unknown: '未检测到',
    settings_tts_voice_default: '系统默认语音',
    plugins_load_failed: '插件加载失败：',
    plugins_no_hooks: '未注册生命周期钩子',
    plugins_unnamed: '未命名插件',
    plugins_no_description: '无描述。',
    plugins_registered_hooks: '已注册钩子',
    plugins_enabled: '已启用',
    ...
    status_updated: '已更新',
    status_ephemeral: '临时快照 — 未写入对话记录。',
    status_no_tokens: '无 Token 数据',
    status_profile: '配置档',
    status_hermes_home: '云千易 目录',
    status_started: '开始时间',
    status_tokens: 'Token',
    status_unknown: '未知',
    cmd_yolo: 'YOLO 模式切换',
    ...
    composer_placeholder: '对话 {0}…',
    composer_mobile_workspace: '工作区',
    composer_workspace_toggle_label: '\u5de5\u4f5c\u7a7a\u95f4',
    composer_mobile_model: '模型',
    composer_mobile_reasoning: '推理',
    composer_mobile_context: '上下文',
    reasoning_effort_title: '思考深度',
    reasoning_effort_none: '关闭',
    reasoning_effort_default: '默认',
    reasoning_effort_minimal: '极低',
    reasoning_effort_low: '低',
    reasoning_effort_medium: '中',
    reasoning_effort_high: '高',
    reasoning_effort_xhigh: '极高',
    reasoning_effort_chip_title: '思考深度：{0}',
    reasoning_toast_set: '已将思考深度设为 {0}',
    reasoning_toast_failed: '设置思考深度失败',
    composer_mobile_config_title: '工作区、模型、推理与上下文',
    composer_workspace_group_aria: '工作区操作',
    ctx_tooltip_title: '上下文窗口',
    ctx_indicator_aria: '上下文窗口占用',
    bg_badge_title: '后台任务运行中',
    drop_files_hint: '拖放文件到此处以上传到工作区',
    composer_attach: '添加附件',
    queue_region_aria: '排队消息',
    queue_pill_aria: '显示排队消息',
    insights_period_7: '最近 7 天',
    insights_period_30: '最近 30 天',
    insights_period_90: '最近 90 天',
    insights_period_365: '最近 365 天',
    gateway_status_label: '网关状态',
    gateway_status_desc: '云千易 网关状态（Telegram、Discord、Slack 等）',
    gateway_loading: '加载中…',
    agent_health_details: '网关心跳失败，恢复前消息可能无法送达。',
    agent_health_state: '状态：{0}。',
    agent_health_alert_message: '网关心跳失败。{0}恢复前消息可能无法送达。',
    update_whats_new: '更新说明',
    update_later: '稍后',
    update_now: '立即更新',
    update_force: '强制更新',
    reconnect_dismiss: '忽略',
    reconnect_reload: '重新加载',
    agent_health_dismiss: '关闭',
    workspace_file_unread_tooltip: '此会话内新增或更新的文件，尚未打开或下载',
    workspace_panel_title: '工作区',
    workspace_panel_hide: '隐藏工作区面板',
    workspace_parent_dir: '上级目录',
    workspace_new_file: '新建文件',
    workspace_new_folder: '新建文件夹',
    workspace_refresh: '刷新',
    workspace_close_preview: '关闭预览',
    workspace_close_panel: '关闭工作区面板',
    workspace_terminal_aria: '工作区终端',
    file_download: '下载',
    file_edit: '编辑',
    preview_pdf_title: 'PDF 预览',
    preview_html_title: 'HTML 预览',
    open_in_new_tab: '在新标签页打开',
    cron_refresh_list_title: '刷新任务列表',
    insights_refresh_title: '刷新',
    model_select_title: '对话模型',
    menu_hamburger: '菜单',
    primary_nav_aria: '主导航',
    scroll_to_bottom_aria: '滚动到底部',
    session_toolsets: '会话工具集',
    session_toolsets_desc: '限制本会话可用的工具（留空则使用全局配置）',
    session_toolsets_global: '全局（默认）',
    session_toolsets_custom: '自定义',
    session_toolsets_placeholder: 'tool1, tool2, …',
    session_toolsets_apply: '应用',
    session_toolsets_clear: '清除（恢复全局）',
    session_toolsets_applied: '工具集已更新',
    session_toolsets_cleared: '已清除工具集，使用全局配置',
    ...
    settings_desc_voice_mode: '在听写麦克风旁显示语音模式按钮（波形图标）。停顿后自动发送并由 云千易 朗读回复；需浏览器同时支持语音识别与 TTS。',
    settings_label_tts_voice: '语音',
    settings_desc_tts_voice: '首选朗读语音，选项来自浏览器可用语音列表。',
    settings_label_tts_rate: '语速',
    settings_label_tts_pitch: '音调',
    checkpoint_date: '日期',
    checkpoint_diff_files_changed: (n) => `变更 ${n} 个文件`,
    checkpoint_diff_no_changes: '此检查点与工作区当前状态之间未发现差异。',
    checkpoint_diff_title: '检查点变更',
    checkpoint_empty: '此工作区暂无检查点。',
    checkpoint_error: '检查点加载失败',
    checkpoint_files: '文件',
    checkpoint_loading: '正在加载检查点…',
    checkpoint_message: '说明',
    checkpoint_restore: '恢复',
    checkpoint_restore_confirm_message: (ckpt) => `将工作区恢复到检查点「${ckpt}」？会用保存版本覆盖文件；在此检查点之后新增的文件不会被删除。`,
    ...
    insights_model_sessions: '会话数',
    insights_model_tokens: 'Token',
    insights_model_cost: '费用',
    insights_model_share: '占比',
    insights_no_usage_data: '暂无用量数据',
    insights_footer: '显示最近 {days} 天的数据',
    insights_input_tokens: '输入',
    insights_messages: '消息',
    insights_models: '模型',
    insights_no_cost: '不可用',
    insights_output_tokens: '输出',
    insights_peak_hour: '高峰：{hour} 点',
    insights_sessions: '会话',
    insights_title: '用量分析',
    insights_token_breakdown: 'Token 构成',
    insights_tokens: 'Token',
    insights_total: '合计',
    settings_desc_api_redact: '自托管若需排查可关闭脱敏（不建议多人共用环境关闭）。',
    settings_label_api_redact: '在 API 响应中脱敏敏感数据',
    voice_error: '当前浏览器不支持语音功能',
  ...
  'zh-Hant': {
    ...
    untitled: '\u672a\u547d\u540d',
    new_conversation_placeholder: '\u65b0\u5c0d\u8a71',
    n_messages: (n) => `${n} \u689d\u8a0a\u606f`,
    load_older_messages: '↑ 向上捲動或點擊以載入較早的訊息',
    model_unavailable: '\uff08\u4e0d\u53ef\u7528\uff09',
    model_unavailable_title: '\u6b64\u6a21\u578b\u5df2\u7d93\u4e0d\u5728\u7576\u524d provider \u5217\u8868\u4e2d',
    provider_mismatch_warning: (m,p)=>`\"${m}\" \u53ef\u80fd\u7121\u6cd5\u5728\u7576\u524d\u914d\u7f6e\u7684\u63d0\u4f9b\u8005 (${p}) \u4e0b\u904b\u4f5c\u3002\u5c1a\u9001\uff0c\u6216\u5728\u7d42\u7aef\u57f7\u884c \`云千易 model\` \u5207\u63db\u3002`,
  ...
  folder_add_as_space_title: '\u65b0\u589e\u70ba\u5de5\u4f5c\u5340\uff1f',
    ...
    settings_section_preferences_meta: '云千易 的預設值與介面行為。',
    ...
    editing: '\u7de8\u8f2f\u4e2d',
    empty_title: '有什麼可以幫忙？',
    empty_title_named: '你好，{0}，有什麼可以幫忙？',
    ...
    settings_desc_sync_insights: '將 WebUI token 使用情況同步到 state.db，使 云千易 /insights 包含瀏覽器會話數據。預設未啟用。',
    ...
    n_messages: (n) => `${n} 則訊息`,
    load_older_messages: '↑ 向上捲動或點擊以載入較早的訊息',
    onboarding_api_key_help_prefix: '\u900f\u904e\u4ee5\u4e0b\u65b9\u5f0f\u5132\u5b58\u70ba 云千易 .env \u6a94\u6848\u4e2d\u7684\u6a5f\u5bc6',
    ...
    onboarding_lead: '\u5feb\u901f\u9010\u6b65\u8a2d\u5b9a\uff1a\u6aa2\u67e5\u4e91\u5343\u6613\u3001\u5132\u5b58\u63d0\u4f9b\u8005\u914d\u7f6e\u3001\u9078\u64c7\u5de5\u4f5c\u5340\u8207\u6a21\u578b\uff0c\u4e26\u53ef\u9078\u64c7\u52a0\u5165\u5bc6\u78bc\u4fdd\u8b77\u3002',
    ...
    onboarding_notice_setup_already_ready: '\u5df2\u5075\u6e2c\u5230\u53ef\u7528\u7684 云千易 \u63d0\u4f9b\u8005\u914d\u7f6e\u3002\u60a8\u53ef\u4ee5\u4fdd\u7559\u6216\u5728\u6b64\u53d6\u4ee3\u3002',
    onboarding_notice_setup_required: '\u5728\u6b64\u9078\u64c7\u5feb\u901f\u63d0\u4f9b\u8005\u8a2d\u5b9a\u8def\u5f91\u3002\u9032\u968e OAuth \u8a2d\u5b9a\u4ecd\u8acb\u4f7f\u7528 云千易 CLI\u3002',
    onboarding_notice_system_ready: '云千易 Agent \u53ef\u5f9e Web UI \u5b58\u53d6\u3002',
    onboarding_notice_system_unavailable: '云千易 Agent \u5c1a\u672a\u5b8c\u5168\u53ef\u7528\u3002\u5f15\u5c0e\u7a0b\u5f0f\u53ef\u80fd\u5b89\u88dd\u5b83\uff0c\u4f46\u63d0\u4f9b\u8005\u8a2d\u5b9a\u53ef\u80fd\u4ecd\u9700\u7d42\u7aef\u6a5f\u3002',
    onboarding_notice_workspace: '\u9019\u4e9b\u503c\u4f7f\u7528\u8207\u4e00\u822c\u61c9\u7528\u7a0b\u5f0f\u76f8\u540c\u7684\u8a2d\u5b9a API\u3002',
    onboarding_oauth_provider_not_ready_body: '\u6b64\u5be6\u4f8b\u8a2d\u5b9a\u4f7f\u7528 <strong>{provider}</strong>\uff0c\u5b83\u4f7f\u7528 OAuth \u800c\u975e API \u91d1\u9470\u3002\u8acb\u5728\u7d42\u7aef\u6a5f\u4e2d\u57f7\u884c <code>云千易 auth</code> \u6216 <code>云千易 model</code> \u9032\u884c\u6388\u6b0a\uff0c\u7136\u5f8c\u91cd\u65b0\u6574\u7406 Web UI\u3002',
    onboarding_oauth_provider_not_ready_title: 'OAuth \u63d0\u4f9b\u8005\u5c1a\u672a\u6388\u6b0a',
    onboarding_oauth_provider_ready_body: '\u6b64\u5be6\u4f8b\u8a2d\u5b9a\u4f7f\u7528\u900f\u904e 云千易 CLI \u914d\u7f6e\u7684 OAuth \u63d0\u4f9b\u8005\uff08<strong>{provider}</strong>\uff09\u3002\u7121\u9700 API \u91d1\u9470 \u2014 \u6309\u7e7c\u7e8c\u5b8c\u6210\u8a2d\u5b9a\u3002',
    onboarding_oauth_provider_ready_title: '\u63d0\u4f9b\u8005\u5df2\u6388\u6b0a',
    onboarding_oauth_switch_hint: '\u6216\u9078\u64c7\u4e0b\u65b9\u5176\u4ed6\u63d0\u4f9b\u8005\u4ee5\u5207\u63db\u5230 API \u91d1\u9470\u8a2d\u5b9a\uff1a',
    onboarding_open: '\u958b\u555f\u4e91\u5343\u6613',
    ...
    onboarding_step_setup_desc: '\u5132\u5b58\u6700\u5c0f\u53ef\u7528\u7684 云千易 \u63d0\u4f9b\u8005\u914d\u7f6e\u3002',
    onboarding_step_setup_title: '\u63d0\u4f9b\u8005\u8a2d\u5b9a',
    onboarding_step_system_desc: '\u9a57\u8b49 云千易 Agent \u8207\u914d\u7f6e\u53ef\u898b\u6027\u3002',
    onboarding_step_system_title: '\u7cfb\u7d71\u6aa2\u67e5',
    onboarding_step_workspace_desc: '\u70ba\u65b0\u6703\u8a71\u9078\u64c7\u9810\u8a2d\u503c\u3002',
    onboarding_step_workspace_title: '\u5de5\u4f5c\u5340\u8207\u6a21\u578b',
    onboarding_title: '\u6b61\u8fce\u4f7f\u7528 云千易',
    onboarding_unknown: '\u672a\u77e5',
    onboarding_workspace_help: '\u9078\u64c7 云千易 \u5728\u8a2d\u5b9a\u5b8c\u6210\u5f8c\u7528\u65bc\u65b0\u804a\u5929\u5ba4\u7684\u6a21\u578b\u3002',
    ...
    providers_oauth_config_yaml_hint: '\u5df2\u900f\u904e config.yaml \u8a2d\u5b9a\u6b0a\u8b49\u3002\u8981\u66f4\u65b0\uff0c\u8acb\u7de8\u8f2f config.yaml \u4e2d\u7684 providers \u5340\u6bb5\uff0c\u6216\u57f7\u884c 云千易 auth\u3002',
    providers_oauth_not_configured_hint: '\u5c1a\u672a\u9a57\u8b49\u3002\u8acb\u5728\u7d42\u7aef\u6a5f\u57f7\u884c 云千易 auth \u4ee5\u8a2d\u5b9a\u6b64\u63d0\u4f9b\u8005\u3002',
    providers_remove: '\u79fb\u9664',
    providers_removing: '\u79fb\u9664\u4e2d\u2026',
    providers_save: '\u5132\u5b58',
  ...
  pt: {
    ...
    untitled: 'Sem título',
    new_conversation_placeholder: 'Nova conversa',
    ...
    provider_mismatch_warning: (m,p)=>`"${m}" pode não funcionar com seu provedor configurado (${p}). Enviar assim mesmo, ou execute \`云千易 model\` no terminal para trocar.`,
    ...
    cmd_skills: 'Listar skills disponíveis do 云千易 ',
    ...
    status_hermes_home: 'Diretório 云千易 ',
    ...
    settings_section_preferences_meta: 'Padrões e comportamento UI do 云千易.',
    ...
    settings_desc_bot_name: 'Nome de exibição do assistente. Padrão: 云千易 .',
    ...
    password_env_var_locked: 'A variável de ambiente 云千易 _WEBUI_PASSWORD está definida e tem prioridade. Remova-a e reinicie o servidor para gerenciar a senha aqui.',
    password_env_var_locked_placeholder: 'Bloqueado: variável 云千易 _WEBUI_PASSWORD está definida',
    ...
    providers_oauth_config_yaml_hint: 'Token configurado via config.yaml. Para atualizar, edite config.yaml ou rode 云千易 auth.',
    providers_oauth_not_configured_hint: 'Não autenticado. Rode 云千易 auth no terminal.',
    ...
    empty_title_named: 'Olá, {0}, como posso ajudar?',
    ...
    onboarding_title: 'Bem-vindo ao 云千易',
    onboarding_lead: 'Uma configuração rápida vai verificar 云千易 , salvar provedor, escolher workspace e modelo, e opcionalmente proteger com senha.',
    ...
    onboarding_step_system_desc: 'Verificar 云千易 Agent e visibilidade da config.',
    onboarding_step_setup_title: 'Configuração do provedor',
    onboarding_step_setup_desc: 'Salvar config mínima do provedor 云千易 .',
    ...
    onboarding_notice_system_ready: '云千易 Agent parece acessível pela Web UI.',
    onboarding_notice_system_unavailable: '云千易 Agent não está totalmente disponível. Bootstrap pode instalar, mas setup do provedor pode requerer terminal.',
    onboarding_check_agent: '云千易 Agent',
    ...
    onboarding_notice_setup_required: 'Escolha caminho simples de provedor aqui. OAuth avançado ainda pertence ao 云千易 CLI.',
    onboarding_notice_setup_already_ready: 'Setup de provedor 云千易 já detectado. Pode manter ou substituir.',
    ...
    onboarding_oauth_provider_not_ready_body: 'Esta instância usa <strong>{provider}</strong> com OAuth. Rode `云千易 auth` no terminal.',
    ...
    onboarding_api_key_placeholder_optional: 'Leave blank for keyless servers', // TODO: translate
    onboarding_api_key_help_keyless: 'Most LM Studio / Ollama / vLLM installs run keyless — leave this blank if your server doesn\'t require authentication. Use the Test connection button to verify.', // TODO: translate
    onboarding_api_key_help_prefix: 'Salvo como segredo no .env do 云千易 usando',
    onboarding_base_url_label: 'Base URL',
    ...
    onboarding_workspace_help: 'Escolha modelo que 云千易 deve usar para novos chats.',
  ...
  ko: {
    ...
    untitled: '제목 없음',
    new_conversation_placeholder: '새 대화',
    ...
    settings_section_preferences_meta: '云千易의 기본값과 UI 동작.',
    ...
    settings_desc_sync_insights: 'WebUI 토큰 사용량을 state.db에 반영하여 云千易 /insights에 브라우저 세션 데이터가 포함되도록 합니다. 기본값은 꺼짐입니다.',
    ...
    password_env_var_locked: '현재 云千易 _WEBUI_PASSWORD 환경 변수가 설정되어 있어 우선 적용됩니다. 변수를 해제하고 서버를 재시작해야 여기에서 비밀번호를 관리할 수 있습니다.',
    password_env_var_locked_placeholder: '잠금: 云千易 _WEBUI_PASSWORD 환경 변수가 설정되어 있습니다',
    ...
    empty_title_named: '{0}님, 무엇을 도와드릴까요?',
    ...
    onboarding_lead: '간단한 안내 설정으로 云千易 설치를 확인하고, 워크스페이스와 모델을 선택하며, 필요하면 비밀번호로 앱을 보호합니다.',
    onboarding_back: '뒤로',
...
/**
 * True for empty title and server/placeholder defaults (incl. localized `untitled` strings).
 * Does not treat custom user titles as default.
 */
function _isBackendDefaultSessionTitle(raw) {
  if (raw == null) return true;
  const v = String(raw).trim();
  if (!v) return true;
  if (v === 'Untitled' || v === 'New Chat' || v === 'New chat') return true;
  try {
    for (const loc of Object.values(LOCALES)) {
      const u = loc && loc.untitled;
      if (typeof u === 'string' && u === v) return true;
    }
  } catch (_) {}
  return false;
}

/** User-visible session title (ephemeral chats show localized label, not backend "Untitled"). */
function sessionDisplayTitle(rawTitle) {
  return _isBackendDefaultSessionTitle(rawTitle)
    ? t('new_conversation_placeholder')
    : (String(rawTitle).trim() || t('new_conversation_placeholder'));
}
...
function applyLocaleToDOM() {
  ...
  if (typeof window.refreshEmptyChatTitle === 'function') window.refreshEmptyChatTitle();
  if (typeof window.applyBotName === 'function') try { window.applyBotName(); } catch (_) {}
  if (typeof syncReasoningChip === 'function') try { syncReasoningChip(); } catch (_) {}
  if (typeof syncToolsetsChip === 'function') try { syncToolsetsChip(); } catch (_) {}
}
